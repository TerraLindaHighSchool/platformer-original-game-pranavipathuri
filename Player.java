...
public class Player extends Actor
{
    ...
    public Player(int speed, float jumpForce, float gravity, int maxHealth, int maxPowerUp, Class nextLevel, GreenfootSound muisc)
    {
    ...
    private void animator()
    {
        if(frame % (15 - 2 * speed) == 0)
        {
          ...
          {
              setImae(WALK_ANIMATION[walkIndex]);
              walkIndex++l;
          }
          else
          {
